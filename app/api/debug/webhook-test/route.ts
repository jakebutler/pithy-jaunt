 ...
 * Test webhook processing without actually sending a webhook
 * 
 * Body:
 * {
 *   "taskId": "...",
...
export async function POST(request: Request) {
  try {
    ...
    console.log("[DEBUG WEBHOOK] Received:", { taskId, workspaceId, prUrl, status });
    ...
    const taskIncluded = workspace.assignedTasks.includes(taskId as Id<"tasks">);
    ...
    console.log("[DEBUG WEBHOOK] Task status updated to:", status === "success" ? "completed" : "failed");
